        ...
        <Paper className={classes.paper}>
          ...
          <form onSubmit={(e)=> this.submitSignup(e)} className={classes.form}>
            ...
            <FormControl required fullWidth margin='normal'>
              ...
              <Input type='password' id='signup-password-input'  onChange={(e)=> this.userTyping('password', e)} autoFocus id='signup-email-input'></Input>
            </FormControl>
            <FormControl required fullWidth margin='normal'>
              <InputLabel htmlFor='signup-password-confirmation'>Confirm Your Password</InputLabel>
              <Input type='password' id='signup-password-confirmation'  onChange={(e)=> this.userTyping('passwordConfirmation', e)} autoFocus id='signup-email-confirmation'></Input>
            </FormControl>
